loadstring(game:HttpGet('https://raw.githubusercontent.com/StaryLOL/Nightmare/main/NightmareGUI/loader.lua'))()

local Library = initLibrary()
local Window = Library:Load({name = "Nightmare", sizeX = 425, sizeY = 512, color = Color3.fromRGB(255, 255, 255)})
